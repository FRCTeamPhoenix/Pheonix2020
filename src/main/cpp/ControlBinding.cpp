...
void ControlBinding::setDefaultControls() {
    ...
    m_controlData["visionAim"] = {JoystickType::DRIVER, ControlType::BUTTON, 3};        // Button 'X'
    ...
    m_controlData["shoot"] = {JoystickType::OPERATOR, ControlType::AXIS, 5};            // Right Axis
    m_controlData["intake"] = {JoystickType::OPERATOR, ControlType::AXIS, 3};         // Right Trigger
    m_controlData["outtake"] = {JoystickType::OPERATOR, ControlType::AXIS, 2};        // Left Trigger
