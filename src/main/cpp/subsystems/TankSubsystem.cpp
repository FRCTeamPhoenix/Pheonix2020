...
void TankSubsystem::init(){
    ...
    //disable soft limits
    m_frontRight.ConfigForwardSoftLimitEnable(false);
    m_frontRight.ConfigReverseSoftLimitEnable(false);
    m_frontLeft.ConfigForwardSoftLimitEnable(false);
    m_frontLeft.ConfigReverseSoftLimitEnable(false);
